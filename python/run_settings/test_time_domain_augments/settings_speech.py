...
parameters = dict(
    ...
    time_domain_augmentations_pos=[0, 1, 2, 3, 4],
    time_domain_augmentations_neg=[0, 1]
)

USE_MIL = False

RUN_COMMENT = f"time_domain_augmentations"
n_epochs = 120
...
DATASET_NAME = "logmel_combined_speech_NEW_23msHop_46msFFT_multiple_augmented_sets"
MODEL_NAME = "resnet18"
