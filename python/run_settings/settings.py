...
parameters = dict(
    ...
    # transfer_func_sim=[0, 3, 6, 12],  # gain for the online augmentation
    # random_gain=[0, 3, (-6, 3)]  # either  one gain the goes positive or negative or separate values in a tuple
)
...
#     use_resnorm=[False],
#     val_oversampl=[1],
#     exclude_conf_miscl=[True, False]  # exclude confidently misclassified examples (manually identified and saved in excel
# )
...
#                  r"_seed99468865_trainedOnFullSet.pth "
# LOAD_FROM_DISC = r"data\Coswara_processed\models\2023-07-11_epoch102_evalMetric_81.9_combined_breaths _seed99468865.pth"  # 224 time steps, 46ms hop size
