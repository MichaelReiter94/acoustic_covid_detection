...
% 0.5   2011-04-29   added option noadjust to cite (do not set space before \cite automatically)
% 0.6   2011-12-17   varioref now also works for german text (bug reported by Angelika Kern)
% 0.7   2012-07-27   added option to control paper size (via \PaperSize)
%
% ***** Todo *****
%
% **************************************************************************************************
